...
```{r stationary, echo=FALSE,fig.align='center',fig.width=12,fig.height=6,cache=TRUE,dev='pdf'}
set.seed(123)
par(mfrow=c(1,2))
phi=0.5
x0=rnorm(1)*0.1
...
cat('Percentage of unit-root processes using PP: ',sum(PP1>0.05)/10,'%',sep='')
```
...
cat('Percentage of unit-root processes using PP: ',sum(PP3>0.05)/10,'%',sep='')
```
